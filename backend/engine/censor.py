...
if '__name__' == "__main__": # wenn dieses Programm an sich ausgeführt wird, dann wird nicht probiert, app.py auszuführen
    ...
    print(image_array)
    img = Image.fromarray(censor(image_array, [[70, 100, 25, 25],[140, 50, 25, 25]], ))
    img.show()
