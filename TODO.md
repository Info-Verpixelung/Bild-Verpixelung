# TODOS
 ...
 - [x] 1. Hochgeladene Fotos einzeln löschbar machen (im preview fenster)
 - [x] 2. beim Hochladen von bildern **keine** bereits hochgeladenen löschen/überschreiben sowohl im hochlade fenster als auch im preview fenster
 - [x] 3. Dark/Light mode switch sichtbarer machen / Beschreibung geben (PS: vollkommen unnötige Zeitverschwendung aber sieht gut aus :'))
